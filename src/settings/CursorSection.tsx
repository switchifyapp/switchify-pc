...
export function CursorSection({ settings, update }: { settings: AppSettings; update: SettingsUpdate }) {
  return <SettingGroup title="Cursor appearance" description="On-screen cursor overlay shown while a mobile device is controlling this computer.">
        ...
        <div className="overlay-options">
          ...
          <OptionGroup<AppSettings["cursorOverlaySize"]> legend="Cursor size" columns="three" disabled={!settings.cursorOverlayEnabled} options={overlaySizeOptions} value={settings.cursorOverlaySize} onChange={(next) => update("cursorOverlaySize", next)} />
