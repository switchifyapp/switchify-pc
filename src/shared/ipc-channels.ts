...
export const GET_POINTER_MOVEMENT_SETTINGS_CHANNEL = 'pointer-movement:get-settings';
export const SET_POINTER_MOVEMENT_SETTINGS_CHANNEL = 'pointer-movement:set-settings';
